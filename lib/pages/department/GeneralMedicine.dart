...
class GeneralMedicine extends StatefulWidget {
  @override
  _GeneralMedicineState createState() => _GeneralMedicineState();
}

class _GeneralMedicineState extends State<GeneralMedicine> {
